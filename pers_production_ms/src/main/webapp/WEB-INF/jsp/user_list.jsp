...
<div id="userRoleWindow" class="easyui-window" title="角色信息" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'user/role_edit'" style="width:45%;height:60%;padding:10px;">
</div>
